...
const Button = styled.button`
    ...
    :hover {
	  ...
	  :active {
>>>>>>> 362da2d3095b1e5633d83d134c70339dac1b0ea4
	...
	const signUpSubmit = async () => {
		try {
			const response = await axios.post(
				process.env.REACT_APP_API_SIGNUP_ENDPOINT,
				{
					displayName,
					email,
					password,
...
>>>>>>> 362da2d3095b1e5633d83d134c70339dac1b0ea4
	...
	return (
		<ContainerStyle>
			...
			<DirectionStyle>
				<MenuStyle>
					<MenuButton className="first">
						<FcGoogle />
						Sign up with Goole
					</MenuButton>
					<MenuButton className="second">
						<VscGithub />
						Sign up with GitHub
					</MenuButton>
					<MenuButton className="third">
						<AiFillFacebook />
				...
				<UnderTextStyle>
					<div className="underText">
						...
						<a href="/login" className="underLink">
							Log in
						</a>
					</div>
					<div className="underText">
